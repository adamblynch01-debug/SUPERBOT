...
client.on('interactionCreate', async interaction => {
  try {
    ...
    if (['gennumber', 'set-5sim-api', 'set-smspool-api'].includes(_smsCmd) || (_smsId && _smsId.startsWith('sms_'))) {
