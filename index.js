  ...
  try {
    ...
    if (interaction.isChatInputCommand()) {
      ...
      if (cmd === 'gensteam') {
        ...
        if (delivered) {
          await interaction.reply({ content: '✅ Sent your account via DM! Check your messages.', flags: 64 });
        } else {
          await interaction.reply({ content: '⚠️ Couldn\'t DM you (your DMs may be closed), so here it is — only you can see this message:', embeds: [embed], flags: 64 });
        }
        return;
      }
