...
function renderPanelPage(session) {
  ...
  <body>
    <div class="wrap">
      ...
      <div class="win">
        ...
        <div class="win-body">
          <div class="warn">⚠ Saves to the database, but the bot still loads most config from Railway env vars at startup — editing here won't change bot behaviour yet. Treat this as staging until that's wired up.</div>
  ...
  <script>
    ...
    async function saveSettings() {
      ...
      alert('Saved to database. Remember: the bot doesn\\'t read these live yet — see the note above.');
    }
